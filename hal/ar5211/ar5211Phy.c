...
#ident "$Id: //depot/sw/branches/AV_dev/src/hal/ar5211/ar5211Phy.c#1 $"
...
void
ar5211AttachRateTables(WLAN_DEV_INFO *pDev)
{
    /*
     * Attach device specific rate tables; for ar5211, g is
     * really pure-g and thus corresponds to the 11a table
     */
    pDev->hwRateTable[WIRELESS_MODE_11a]   = &ar5211_11aRateTable;
    pDev->hwRateTable[WIRELESS_MODE_TURBO] = &ar5211_TurboRateTable;
    pDev->hwRateTable[WIRELESS_MODE_11b]   = &ar5211_11bRateTable;
    pDev->hwRateTable[WIRELESS_MODE_11g]   = &ar5211_11aRateTable;
    pDev->hwRateTable[WIRELESS_MODE_XR]    = NULL;
}
