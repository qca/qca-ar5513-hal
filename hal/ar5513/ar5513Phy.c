...
#ident "$Id: //depot/sw/branches/AV_dev/src/hal/ar5513/ar5513Phy.c#2 $"
...
#ifdef TURBO_PRIME
static RATE_TABLE ar5513_TurboPrimeARateTable = {
    16,  /* number of rates */
    { -1 },
...
#else
static RATE_TABLE ar5513_11aRateTable = {
    8,  /* number of rates */
    { -1 },
    {/*                                                             short            ctrl  RssiAck  RssiAck long Preamble short Preamble*/
     /*              valid                 Kbps  uKbps  rateCode Preamble  dot11Rate Rate ValidMin DeltaMin  ACK Duration   ACK Duration*/
...
static RATE_TABLE ar5513_TurboRateTable = {
    8,  /* number of rates */
    { -1 },
    {/*                                                              short            ctrl  RssiAck  RssiAck long Preamble short Preamble*/
     /*              valid                  Kbps  uKbps  rateCode Preamble  dot11Rate Rate ValidMin DeltaMin  ACK Duration   ACK Duration*/
...
#ifdef TURBO_PRIME
static RATE_TABLE ar5513_TurboPrimeGRateTable = {
    19,  /* number of rates */
    { -1 },
    {/*                                                                short           ctrl  RssiAck  RssiAck long Preamble short Preamble*/
 ...
 */
static RATE_TABLE ar5513_11gRateTable = {
    12,  /* number of rates */
    { -1 },
    {/*                                                              short            ctrl  RssiAck  RssiAck long Preamble short Preamble*/
     /*              valid                  Kbps  uKbps  rateCode Preamble  dot11Rate Rate ValidMin DeltaMin  ACK Duration   ACK Duration*/
...
static RATE_TABLE ar5513_11bRateTable = {
    4,  /* number of rates */
    { -1 },
    {/*                                                             short            ctrl  RssiAck  RssiAck long Preamble short Preamble*/
     /*              valid                 Kbps  uKbps  rateCode Preamble  dot11Rate Rate ValidMin DeltaMin  ACK Duration   ACK Duration*/
...
static RATE_TABLE ar5513_XrRateTable = {
    13,  /* number of rates */
    { -1 },
    {/*                                                              short            ctrl  RssiAck  RssiAck long Preamble short Preamble*/
     /*              valid                  Kbps  uKbps  rateCode Preamble  dot11Rate Rate ValidMin DeltaMin  ACK Duration   ACK Duration*/
...
void
ar5513AttachRateTables(WLAN_DEV_INFO *pDev)
{
    /*
     * Attach device specific rate tables; for ar5513.
     * 11a static turbo and 11g static turbo share the same table.
     * Dynamic turbo uses combined rate table.
     */
    pDev->hwRateTable[WIRELESS_MODE_TURBO] = &ar5513_TurboRateTable;
    pDev->hwRateTable[WIRELESS_MODE_11b]   = &ar5513_11bRateTable;
#ifdef TURBO_PRIME
    pDev->hwRateTable[WIRELESS_MODE_11a]   = &ar5513_TurboPrimeARateTable;
    pDev->hwRateTable[WIRELESS_MODE_11g]   = &ar5513_TurboPrimeGRateTable;
#else
    pDev->hwRateTable[WIRELESS_MODE_11a]   = &ar5513_11aRateTable;
    pDev->hwRateTable[WIRELESS_MODE_11g]   = &ar5513_11gRateTable;
#endif
    pDev->hwRateTable[WIRELESS_MODE_108g]  = &ar5513_TurboRateTable;
    pDev->hwRateTable[WIRELESS_MODE_XR]    = &ar5513_XrRateTable;
#if defined(XR_HACKERY)
#ifdef TURBO_PRIME
    pDev->hwRateTable[WIRELESS_MODE_XR]    = &ar5513_TurboPrimeARateTable;
#else
    pDev->hwRateTable[WIRELESS_MODE_XR]    = &ar5513_11aRateTable;
#endif
#endif  
}
